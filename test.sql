...
--CTE(custom table Expressions) temprary result sets , readability , reusaibility of complex queries
-- that are defined within single execution of sql statement
